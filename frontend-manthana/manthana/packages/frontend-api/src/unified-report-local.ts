 ...
 */
import type { AnalysisResponse, UnifiedAnalysisResult } from "./types";

const LABS_PRIMARY = "Manthana Cloud AI";
...
export function buildLocalUnifiedFromResults(
  ...
  return {
    ...
    confidence: "high",
    models_used: [LABS_PRIMARY, ...results.flatMap((r) => r.result.models_used)],
    processing_time_sec:
